...
its_wrong = load_from_pickle(f'{root_dir}/Data/DPO/USPTO_balance/Complete/USPTO_balance_its_incorrect.pkl.gz')
its_correct = load_from_pickle(f'{root_dir}/Data/DPO/USPTO_balance/Complete/USPTO_balance_its_correct.pkl.gz')
def batch_process_items(data_items, batch_size):
    ...
    for i in range(0, len(data_items), batch_size):
        ...
        print(f"Processing batch {i // batch_size + 1}/{(len(data_items) + batch_size - 1) // batch_size}")
...
save_to_pickle(its_correct, f'{root_dir}/Data/DPO/USPTO_balance/Expand/USPTO_balance_its_correct.pkl.gz')
