...
class BalanceReactionCheck:
    ...
    def __init__(self, input_data: Union[str, List[Union[str, Dict[str, str]]]], rsmi_column: str = 'reactions', n_jobs: int = -1, verbose: int = 0):
        """
    ...
    def parse_input(self, input_data: Union[str, List[Union[str, Dict[str, str]]]]) -> List[Dict[str, str]]:
        """
    ...
    @staticmethod
    def is_balanced(reaction_dict: Dict[str, str],
                    rsmi_column: str) -> Dict[str, Union[bool, str]]:
        """
        ...
        reactants_forumula = BalanceReactionCheck.mol_to_molecular_formula(reactants_mols)
    ...
    def check_balances(self) -> Tuple[List[Dict[str, Union[bool, str]]], List[Dict[str, Union[bool, str]]]]:
        """
        ...
        """
        results = Parallel(n_jobs=self.n_jobs, verbose=self.verbose)(delayed(self.is_balanced)(reaction, self.rsmi_column) for reaction in self.reactions)
        
        balanced_reactions = [reaction for reaction in results if reaction['balanced']]
        unbalanced_reactions = [reaction for reaction in results if not reaction['balanced']]
