...
class ITSHAdjuster:
    ...
    def add_hydrogen_nodes(
        ...
        if react_node_to_add_hydrogen:
            ...
            react_graph_copy.add_edge(
                react_node_to_add_hydrogen,
                max_index,
                order=1.0,
                ez_isomer="N",
                bond_type="SINGLE",
        ...
        if prod_node_to_add_hydrogen:
            ...
            prod_graph_copy.add_edge(
                prod_node_to_add_hydrogen,
                max_index,
                order=1.0,
                ez_isomer="N",
                bond_type="SINGLE",
    ...
    def process_single_graph_data(
        ...
        if hcount_change == 0:
            ...
            react_graph, prod_graph = ITSHAdjuster.add_hydrogen_nodes(
                react_graph.copy(), prod_graph.copy()
            )
    ...
    def add_hydrogen_nodes_multiple(
        ...
        for permutation in permutations:
            ...
            current_react_graph = ITSHAdjuster.add_hydrogen_nodes_multiple_utils(
                current_react_graph,
                zip(hydrogen_nodes_break, permutations_seed),
                atom_map_update=False,
            )
