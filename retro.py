...
# python scripts/retro.py --log_dir ./Data/DPO/USPTO_balance/Complete/Log/rules_r0_log.txt --data_dir ./Data/DPO/USPTO_balance/valid.json.gz --rule_file_path ./Data/DPO/USPTO_balance/Complete/R0 --save_dir ./Data/DPO/USPTO_balance/Complete/Output --radius 0
