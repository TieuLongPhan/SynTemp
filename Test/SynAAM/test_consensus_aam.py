...
class TestConsensusAAM(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.consensus_aam = ConsensusAAM(
            self.reactions_list,
    ...
    def test_extract_smiles(self):
        ...
        self.assertEqual(
            smiles_list,
            [
                "C=CCC(N)(c1ccccc1)c1ccccc1.O=CC(C(=O)N1CCOCC1)c1ccccc1>>C=CCC(N=C(c1ccccc1)c1ccccc1)C(C(=O)N1CCOCC1)c1ccccc1",
    ...
    def test_run(self):
        ...
        updated_list = self.consensus_aam.fit(
            batch_size=1,
            rxn_mapper=self.rxnmapper,
            rdt_jar_path=self.rdt_jar_path,
            working_dir="./",
        )
