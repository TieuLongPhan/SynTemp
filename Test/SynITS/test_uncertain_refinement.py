...
class TestUncertainRefinement(unittest.TestCase):
    ...
    def test_check_graph_type(self):
        ...
        self.assertEqual(UncertainRefinement.check_graph_type(single_cycle_graph), "Single Cyclic")
        self.assertEqual(UncertainRefinement.check_graph_type(two_cycle_graph), "Complex Cyclic")
